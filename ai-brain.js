...
[[ACTION:type=cart_recovery|name=שם הלקוחה|email=כתובת מייל|phone=טלפון|coupon=15|coupon_days=30|subject=נושא ההודעה|body=תוכן ההודעה המלא כאן עם {COUPON} במקום שבו הקוד יופיע]]
כללים לבלוק הפעולה:
...
- {COUPON} בתוך ה-body יוחלף אוטומטית בקוד הקופון האמיתי שייווצר. אל תמציא קוד קופון בעצמך.
